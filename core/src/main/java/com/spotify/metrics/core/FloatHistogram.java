...
/**
 * Adapted from https://github.com/tdunning/t-digest/blob/c55e6ba9c717e07aa1e4dcb9489967b53963dd91/core/src/main/java/com/tdunning/math/stats/FloatHistogram.java
 */
...
class FloatHistogram extends Histogram {
    ...
    long[] getCompressedCounts() {
        ...
        Simple64.compress(buf, getCounts(), 0, counts.length);
    ...
    void writeObject(java.io.ObjectOutputStream out) throws IOException {
        ...
        Simple64.compress(longBuffer, getCounts(), 0, counts.length);
    ...
    void add(Iterable<Histogram> others) {
        for (Histogram other : others) {
            ...
            for (int i = 0; i < counts.length; i++) {
                counts[i].add(other.counts[i].longValue());
            }
        }
    }
}