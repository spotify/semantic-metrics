...
/**
 * This class is an adaptation of Dropwizard's InstrumentedScheduledExecutorService that uses
 * {@link com.spotify.metrics.core.SemanticMetricRegistry}.
 *
 * Just as Dropwizard's, this class wraps an {@link java.util.concurrent.ScheduledExecutorService} and monitors the number of
 * tasks submitted, running, completed and keeps a {@link com.codahale.metrics.Timer} to track task duration.
 *
...
public class InstrumentedScheduledExecutorService implements ScheduledExecutorService {
  ...
  /**
   * Wraps an {@link java.util.concurrent.ScheduledExecutorService} uses an auto-generated default name.
   *
   ...
   */
  public InstrumentedScheduledExecutorService(ScheduledExecutorService delegate, SemanticMetricRegistry registry) {
    this(delegate, registry, new MetricId().tagged("executor", "scheduled-executor-" + NAME_COUNTER.incrementAndGet()));
  }
  ...
  public InstrumentedScheduledExecutorService(ScheduledExecutorService delegate,
    ...
    this.scheduledRepetitively = registry.meter(baseMetricIdWithUnit.tagged("what", "scheduled.repetitively"));
    this.scheduledOverrun = registry.counter(baseMetricIdWithUnit.tagged("what", "scheduled.overrun"));
    this.percentOfPeriod = registry.histogram(baseMetricIdWithUnit.tagged("what", "scheduled.percent-of-period"));
  }
